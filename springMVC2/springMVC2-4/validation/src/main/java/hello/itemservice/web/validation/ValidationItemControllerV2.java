...
public class ValidationItemControllerV2 {
    ...
    private final ItemValidator itemValidator; //생성자 1 파라미터 2
    ...
    public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (resultPrice < 10_000) {
                bindingResult.addError(new ObjectError("item", "가격 * 수량의 합은 10,000이상 이어야합니다. 현재 값 = " + resultPrice));
            }
        }
...
//            model.addAttribute("errors",bindingResult); 생략가능
    ...
    public String addItemV2(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (resultPrice < 10_000) {
                bindingResult.addError(
                        new ObjectError("item", null, null, "가격 * 수량의 합은 10,000이상 이어야합니다. 현재 값 = " + resultPrice));
            }
        }
    ...
    public String addItemV3(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (resultPrice < 10_000) {
                bindingResult.addError(
                        new ObjectError("item", new String[]{"totalPriceMin"}, new Object[]{10_000, resultPrice},
                                null));
            }
        }
...
//        ValidationUtils.rejectIfEmptyOrWhitespace(bindingResult,"itemName","required"); // 한줄로 가능
        // 검증 로직
        if (!StringUtils.hasText(item.getItemName())) {
            bindingResult.rejectValue("itemName", "required");
//            new String[]{"required.item.itemName","required"}; 스프링 배열로 관리.
        }
...
//    @PostMapping("/add")
    ...
    public String addItemV6(@Validated @ModelAttribute Item item, BindingResult bindingResult,
                            RedirectAttributes redirectAttributes) { // annotation add, initBinder 추가
